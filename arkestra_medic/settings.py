...
CMS_TEMPLATES = (
    ...
    ('cardiff/medic/cancer.html', gettext('Cancer and Genetics')),
    ('cardiff/medic/primary_care.html', gettext('Primary Care and Public Health')),
    ...
    ('cardiff/medic/experimental_medicine.html', gettext('Molecular and Experimental Medicine')),
    ('cardiff/medic/psychological_medicine.html', gettext('Psychological Medicine and Clinical Neurosciences')),
    ('cardiff/medic/time.html', gettext('Translation, Innovation, Methodology & Engagement')),
